// UMD: this canonical world-march core is loaded directly in three ways — Node
// `require` (backend + tests), the WeChat minigame's module require, and the H5
// browser as a classic <script> that exposes `window.WorldMarchCore`. It is the
// single source of truth; there is no hand-copied browser fallback.
(function (global) {
  ...
  // CommonJS (Node/minigame) gets module.exports; the classic-script browser gets
  // a window global. Node is left un-polluted so requiring this changes nothing
  // about backend globals.
