...
require('../js/platform/renderers/WorldActorLayerManager');
require('../js/platform/renderers/WorldMapCacheCoordinator');
require('../js/platform/renderers/WorldMapHitTargetCollector');
...
require('../js/platform/renderers/BattleSpriteRenderer');
...
require('../js/platform/CanvasWorldMarchActionHandlers');
...
require('../js/platform/CanvasGameAppAssetLoading');
require('../js/platform/CanvasGameAppSecondaryPanels');
