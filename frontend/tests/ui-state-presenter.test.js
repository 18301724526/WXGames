...
test('famous person view state maps candidates and joined people into panel cards', () => {
  ...
  assert.equal(view.people[0].appearance.layers.outfit, 'assets/art/famous-person/layers/fp-layer-outfit-vanguard-front-candidate-02.png');
