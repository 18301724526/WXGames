...
test('world scouting uses dedicated site icons and military scout controls', () => {
  ...
  assert.match(html, /H5ShellAdapter\.js\?v=h5-floating-shell-v1/);
  assert.doesNotMatch(html, /DOMHelper\.js/);
  assert.match(html, /app\.js\?v=h5-floating-shell-v1/);
  assert.match(html, /auth\.js\?v=h5-auth-runtime-v1/);
