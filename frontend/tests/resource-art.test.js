...
test('world scouting uses dedicated site icons and canvas military controls', () => {
  ...
  assert.match(renderer, /renderWorldTileMap/);
  ...
  assert.match(renderer, /type: 'worldMapDrag'/);
  ...
  assert.match(html, /UIStatePresenter\.js\?v=tile-map-home-step1-v1/);
  ...
  assert.match(html, /CanvasGameRenderer\.js\?v=world-map-baked-drag-v1/);
  assert.match(html, /CanvasGameApp\.js\?v=world-map-baked-drag-v1/);
  ...
  assert.match(html, /H5UpdateRuntimeAdapter\.js\?v=h5-update-runtime-v6/);
  ...
  assert.match(html, /H5CanvasRuntime\.js\?v=world-map-baked-drag-v1/);
  assert.match(html, /CanvasGameShell\.js\?v=world-map-baked-drag-v1/);
