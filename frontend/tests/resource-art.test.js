...
test('world scouting uses dedicated site icons and canvas military controls', () => {
  ...
  assert.match(html, /GameAPI\.js\?v=[^"]+/);
  assert.match(html, /CanvasGameRenderer\.js\?v=[^"]+/);
  assert.match(html, /CanvasGameApp\.js\?v=[^"]+/);
  ...
  assert.match(html, /GameStateSync\.js\?v=[^"]+/);
  ...
  assert.match(html, /CanvasGameShell\.js\?v=[^"]+/);
