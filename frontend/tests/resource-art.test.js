...
test('world scouting uses dedicated site icons and military scout controls', () => {
  ...
  assert.match(html, /style\.css\?v=territory-owner-v1/);
  assert.match(html, /GameAPI\.js\?v=territory-owner-v1/);
  assert.match(html, /TerritoryController\.js\?v=territory-owner-v1/);
  assert.match(html, /TerritoryUIRenderer\.js\?v=territory-owner-v1/);
  assert.match(html, /app\.js\?v=territory-owner-v1/);
