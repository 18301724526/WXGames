...
test('Browser entry loads Canvas game shell before app as the authoritative UI surface', () => {
  ...
  assert.match(html, /js\/config\/FamousPortraitLayout\.js\?v=famous-portrait-hair-anchors-v2[\s\S]*js\/platform\/CanvasGameRenderer\.js\?v=famous-portrait-hair-anchors-v2/);
