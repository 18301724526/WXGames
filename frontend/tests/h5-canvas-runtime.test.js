...
test('Browser entry loads Canvas game shell before app as the authoritative UI surface', () => {
  ...
  assert.match(html, /js\/platform\/H5CanvasRuntime\.js\?v=tech-tree-route-map-v1/);
  assert.match(html, /js\/platform\/CanvasActionController\.js\?v=tech-tree-route-map-v1[\s\S]*js\/platform\/CanvasGameShell\.js\?v=tech-tree-route-map-v1/);
  assert.match(html, /js\/platform\/CanvasGameShell\.js\?v=tech-tree-route-map-v1[\s\S]*app\.js\?v=h5-bootstrap-explicit-doc-v3/);
