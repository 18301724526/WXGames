...
test('app delegates update reload runtime instead of touching browser globals directly', () => {
  ...
  assert.match(html, /H5UpdateRuntimeAdapter\.js\?v=h5-update-runtime-v1[\s\S]*H5ShellAdapter\.js\?v=state-normalizer-injection-v1[\s\S]*app\.js\?v=state-normalizer-injection-v1/);
