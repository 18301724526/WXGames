...
test('app delegates update reload runtime instead of touching browser globals directly', () => {
  ...
  assert.match(html, /H5UpdateRuntimeAdapter\.js\?v=h5-update-runtime-v1[\s\S]*H5ShellAdapter\.js\?v=territory-presenter-v1[\s\S]*app\.js\?v=h5-bootstrap-explicit-doc-v1/);
