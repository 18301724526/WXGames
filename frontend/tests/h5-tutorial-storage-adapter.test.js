...
test('tutorial controller and app delegate local storage to H5 tutorial storage adapter', () => {
  ...
  assert.match(html, /H5TutorialStorageAdapter\.js\?v=h5-tutorial-storage-v1[\s\S]*H5ShellAdapter\.js\?v=state-manager-building-v1[\s\S]*TutorialController\.js\?v=tutorial-scheduler-v1[\s\S]*app\.js\?v=state-manager-building-v1/);
