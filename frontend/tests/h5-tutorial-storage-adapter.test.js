...
test('tutorial controller and app delegate local storage to H5 tutorial storage adapter', () => {
  ...
  assert.match(html, /H5TutorialStorageAdapter\.js\?v=h5-tutorial-storage-v1[\s\S]*H5ShellAdapter\.js\?v=h5-tutorial-storage-v1[\s\S]*TutorialController\.js\?v=h5-tutorial-storage-v1[\s\S]*app\.js\?v=h5-tutorial-storage-v1/);
