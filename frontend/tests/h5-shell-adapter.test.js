...
test('app receives H5 shell instead of assembling every document adapter itself', () => {
  ...
  assert.match(html, /js\/ui\/H5ShellAdapter\.js\?v=h5-auth-storage-v1/);
  assert.match(html, /js\/ui\/H5ShellAdapter\.js\?v=h5-auth-storage-v1[\s\S]*app\.js\?v=h5-auth-storage-v1/);
