...
test('stage 18 canvas navigation shell app version is 0.1.25 in package metadata', () => {
...
test('version service reads updated 0.1.25 package version', () => {
  ...
  assert.equal(info.version, '0.1.25');
