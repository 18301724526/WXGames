...
test('stage 6 hud input app version is 0.1.9 in package metadata', () => {
...
test('version service reads updated 0.1.9 package version', () => {
  ...
  assert.equal(info.version, '0.1.9');
