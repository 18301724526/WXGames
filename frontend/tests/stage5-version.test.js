...
test('resetWorldPan dispatcher migration app version is 0.1.44 in package metadata', () => {
  ...
  assert.equal(packageLock.version, '0.1.44');
  assert.equal(packageLock.packages[''].version, '0.1.44');
});

test('version service reads updated 0.1.44 package version', () => {
