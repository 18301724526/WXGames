...
test('shared canvas core version is 0.1.77 in package metadata', () => {
...
test('version service reads updated 0.1.77 package version', () => {
  ...
  assert.equal(info.version, '0.1.77');
