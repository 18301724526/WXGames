...
test('stage 10 canvas tech app version is 0.1.17 in package metadata', () => {
...
test('version service reads updated 0.1.17 package version', () => {
  ...
  assert.equal(info.version, '0.1.17');
