...
test('auth module and app delegate browser storage to H5 auth storage adapter', () => {
  ...
  assert.match(html, /H5AuthStorageAdapter\.js\?v=h5-auth-storage-v1[\s\S]*H5ShellAdapter\.js\?v=state-manager-building-v1[\s\S]*app\.js\?v=state-manager-building-v1/);
