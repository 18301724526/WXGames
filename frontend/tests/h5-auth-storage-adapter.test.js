...
test('auth module and app delegate browser storage to H5 auth storage adapter', () => {
  ...
  assert.match(html, /H5AuthStorageAdapter\.js\?v=h5-storage-runtime-v1[\s\S]*H5ShellAdapter\.js\?v=h5-shell-registry-v1[\s\S]*app\.js\?v=h5-bootstrap-explicit-doc-v1/);
