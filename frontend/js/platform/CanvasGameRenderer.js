  ...
  class CanvasGameRenderer {
    ...
    renderGuidebookPanel(state = {}, options = {}) {
      ...
      if (active.id === 'planning' && view.planning) {
        ...
        this.drawText(`宜居度：${view.planning.text.habitability} ${view.planning.habitabilityLabel} · ${view.planning.text.populationGrowthStatus || '人口成长平稳'}`, contentX + 26, planningY + 36, {
          size: 12,
          bold: true,
          color: '#74d3a0',
        });
    ...
    renderPopulation(state = {}, startY = 84) {
      ...
      this.drawText(`宜居度 ${planning.text?.habitability || '+0'} · ${planning.text?.populationGrowthStatus || '人口成长平稳'}`, x + width - 20, planningY + 12, {
        size: 11,
        bold: true,
        color: '#74d3a0',
        align: 'right',
