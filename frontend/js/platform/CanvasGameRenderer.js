(function (global) {
  ...
  class CanvasGameRenderer {
    ...
    get worldTileFastDragActive() { return Boolean(this.worldMapCacheState.worldTileFastDragActive); }
    set worldTileFastDragActive(value) { this.worldMapCacheState.worldTileFastDragActive = Boolean(value); }
    get worldTileStaticCache() { return this.worldMapCacheState.worldTileStaticCache || null; }
    set worldTileStaticCache(value) { this.worldMapCacheState.worldTileStaticCache = value || null; }
    get worldTileStaticCacheKey() { return this.worldMapCacheState.worldTileStaticCacheKey || ''; }
    set worldTileStaticCacheKey(value) { this.worldMapCacheState.worldTileStaticCacheKey = String(value || ''); }
    get worldTileStaticCacheLayoutKind() { return this.worldMapCacheState.worldTileStaticCacheLayoutKind || ''; }
    set worldTileStaticCacheLayoutKind(value) { this.worldMapCacheState.worldTileStaticCacheLayoutKind = String(value || ''); }
    get worldTileStaticCacheLayout() { return this.worldMapCacheState.worldTileStaticCacheLayout || null; }
    set worldTileStaticCacheLayout(value) { this.worldMapCacheState.worldTileStaticCacheLayout = value || null; }
    get worldTileStaticChunkCaches() { return this.worldMapCacheState.worldTileStaticChunkCaches; }
    get worldTileStaticChunkCacheTick() { return Number(this.worldMapCacheState.worldTileStaticChunkCacheTick) || 0; }
    set worldTileStaticChunkCacheTick(value) { this.worldMapCacheState.worldTileStaticChunkCacheTick = Number(value) || 0; }
    get worldTileWaterLayerCache() { return this.worldMapCacheState.worldTileWaterLayerCache || null; }
    set worldTileWaterLayerCache(value) { this.worldMapCacheState.worldTileWaterLayerCache = value || null; }
    get worldTileWaterLayerCacheKey() { return this.worldMapCacheState.worldTileWaterLayerCacheKey || ''; }
    set worldTileWaterLayerCacheKey(value) { this.worldMapCacheState.worldTileWaterLayerCacheKey = String(value || ''); }
    get worldTileWaterFrameCaches() { return this.worldMapCacheState.worldTileWaterFrameCaches; }
    get worldTileWaterChunkCaches() { return this.worldMapCacheState.worldTileWaterChunkCaches; }
    get worldTileWaterChunkCacheTick() { return Number(this.worldMapCacheState.worldTileWaterChunkCacheTick) || 0; }
    set worldTileWaterChunkCacheTick(value) { this.worldMapCacheState.worldTileWaterChunkCacheTick = Number(value) || 0; }
    get worldTileMaskCache() { return this.worldMapCacheState.worldTileMaskCache; }
    get worldTileMaskMetricsCache() { return this.worldMapCacheState.worldTileMaskMetricsCache; }
    get worldTileDryCompositeCache() { return this.worldMapCacheState.worldTileDryCompositeCache; }
    get worldTileFastDragComposite() { return this.worldMapCacheState.worldTileFastDragComposite || null; }
    set worldTileFastDragComposite(value) { this.worldMapCacheState.worldTileFastDragComposite = value || null; }
    get worldTileFastDragCompositeCache() { return this.worldMapCacheState.worldTileFastDragCompositeCache || null; }
    set worldTileFastDragCompositeCache(value) { this.worldMapCacheState.worldTileFastDragCompositeCache = value || null; }
    get worldTileCompositeCanvas() { return this.worldMapCacheState.worldTileCompositeCanvas || null; }
    set worldTileCompositeCanvas(value) { this.worldMapCacheState.worldTileCompositeCanvas = value || null; }
    get worldTileCompositeCtx() { return this.worldMapCacheState.worldTileCompositeCtx || null; }
    set worldTileCompositeCtx(value) { this.worldMapCacheState.worldTileCompositeCtx = value || null; }
    get worldTileWaterCanvas() { return this.worldMapCacheState.worldTileWaterCanvas || null; }
    set worldTileWaterCanvas(value) { this.worldMapCacheState.worldTileWaterCanvas = value || null; }
    get worldTileWaterCtx() { return this.worldMapCacheState.worldTileWaterCtx || null; }
    set worldTileWaterCtx(value) { this.worldMapCacheState.worldTileWaterCtx = value || null; }
    get worldTileViewCache() { return this.worldMapCacheState.worldTileViewCache || null; }
    set worldTileViewCache(value) { this.worldMapCacheState.worldTileViewCache = value || null; }
    get worldTileVisibleEntriesCache() { return this.worldMapCacheState.worldTileVisibleEntriesCache || null; }
    set worldTileVisibleEntriesCache(value) { this.worldMapCacheState.worldTileVisibleEntriesCache = value || null; }
    get worldTileLocalEntriesCache() { return this.worldMapCacheState.worldTileLocalEntriesCache || null; }
    set worldTileLocalEntriesCache(value) { this.worldMapCacheState.worldTileLocalEntriesCache = value || null; }
    get assetsChangedHandler() { return this.worldMapCacheState.assetsChangedHandler || null; }
    set assetsChangedHandler(value) {
      this.worldMapCacheState.assetsChangedHandler = typeof value === 'function' ? value : null;
    }
    get worldTileCachePrewarmTask() { return this.worldMapCacheState.worldTileCachePrewarmTask || null; }
    set worldTileCachePrewarmTask(value) { this.worldMapCacheState.worldTileCachePrewarmTask = value || null; }
