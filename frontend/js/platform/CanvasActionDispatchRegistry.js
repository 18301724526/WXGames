(function (global) {
  const FINISH_ACTIONS = {
    ...
    changeArmyFormationSoldiers: { method: 'changeArmyFormationSoldiers' },
    requestArmyFormationSoldierInput: { method: 'requestArmyFormationSoldierInput' },
    autoReplenishArmyFormation: { method: 'autoReplenishArmyFormation' },
    confirmArmyFormationSoldiers: { method: 'confirmArmyFormationSoldiers' },
