(function (global) {
  ...
  class MapCommandCanvasRenderer {
    ...
    getMapHomeFloatingButtonLayout(...args) { const surface = this.drawingSurface; return surface && typeof surface.getMapHomeFloatingButtonLayout === 'function' ? surface.getMapHomeFloatingButtonLayout(...args) : this.host?.getMapHomeFloatingButtonLayout?.(...args); }
