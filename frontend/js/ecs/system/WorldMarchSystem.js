(function (global) {
  ...
  const WorldMarchGeometry = (() => {
    ...
    if (typeof module !== 'undefined' && module.exports) return require('../foundation/WorldMarchGeometry');
    return null;
  })();

  const WorldActorProjection = (() => {
    if (global.WorldActorProjection) return global.WorldActorProjection;
    if (typeof module !== 'undefined' && module.exports) return require('../projection/WorldActorProjection');
    return null;
  })();
