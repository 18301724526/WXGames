...
var EcsModeRuntime = (() => {
  ...
  // frontend/js/shared/WorldMarchCoreAdapter.js
  var require_WorldMarchCoreAdapter = __commonJS({
    'frontend/js/shared/WorldMarchCoreAdapter.js'(exports, module) {
      (function (global) {
        const existing = global.WorldMarchCore;
        if (existing && existing.computeMarchState) {
        ...
        const inlineCore = (() => {
          ...
          function appendRouteRevealSource(
            ...
            if (!normalized.tileId) return sources;
            const nextStrength = clampUnit(strength);
            const existing2 = sources.find((item) => item.tileId === normalized.tileId);
            if (existing2) {
              existing2.strength = Math.max(existing2.strength, nextStrength);
              return sources;
            }
            sources.push({
              q: normalized.q,
        ...
        const api = requiredCore || inlineCore;
        global.WorldMarchCore = api;
        if (typeof module !== 'undefined' && module.exports) module.exports = api;
      })(typeof window !== 'undefined' ? window : globalThis);
    },
  });
    ...
    'frontend/js/ecs/system/FogRevealModel.js'(exports, module) {
      (function (global) {
        ...
        function resolveWorldMarchCore() {
          ...
          if (typeof module !== 'undefined' && module.exports) {
            try {
              return require_WorldMarchCoreAdapter();
            } catch (_error) {
              return null;
            }
          }
