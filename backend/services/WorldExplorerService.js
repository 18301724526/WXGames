...
module.exports = {
  ...
  DEFAULT_RANDOM_ROUTE_LENGTH: Shared.DEFAULT_RANDOM_ROUTE_LENGTH,
  MAX_RANDOM_ROUTE_LENGTH: Shared.MAX_RANDOM_ROUTE_LENGTH,
  ...
  startExplore: Actions.startExplore,
  claimExplore: Actions.claimExplore,
  getClientState: ClientState.getClientState,
  buildRandomRoute: RoutePlanner.buildRandomRoute,
