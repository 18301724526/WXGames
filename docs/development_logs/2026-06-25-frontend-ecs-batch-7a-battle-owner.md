# Frontend ECS Batch 7A (Battle Owner) - 2026-06-25
...
Batch 7A establishes a Battle owner for battle overlay/session facts only:
...
- `schema`: fixed string `battle-owner-v1`
...
5. Tighten `check-frontend-ecs-battle-owner.js` so App-side
...
- `node --test frontend/js/ecs/owner/BattleOwner.test.js frontend/js/ecs/snapshot/RendererSnapshotBoundary.test.js frontend/js/platform/CanvasModeOwnershipBridge.test.js frontend/js/platform/CanvasGameApp.test.js scripts/check-frontend-ecs-battle-owner.test.js`
- `node --test scripts/check-frontend-ecs-battle-owner.test.js scripts/check-frontend-ecs-mode-ownership-spine.test.js`
- `node scripts/check-frontend-ecs-battle-owner.js`
