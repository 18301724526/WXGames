...
- Batch 4 reached `Ready for Migration Owner Review` after the resolver, bridge helper, router adapters, scoped guard, and tests were completed and verified; it may move to `Completed` only after `codex/external-review` signs off.
