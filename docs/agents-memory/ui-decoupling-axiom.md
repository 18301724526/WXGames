...
**设计文档状态更新**：该设计文档已随 38dbaab6 删除（git 历史可取）；77735c43 过渡修已于 2026-07-09 拆除；PanelChrome 方向已被 ModalPlateRenderer 单源 painter（五面板已迁）部分实现。原文档：[docs/architecture/ui-surface-decoupling-design-2026-07-09.md](../../docs/architecture/ui-surface-decoupling-design-2026-07-09.md)
