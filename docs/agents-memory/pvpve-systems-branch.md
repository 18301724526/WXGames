...
⚠️ 2026-07-09 起分支已并入单一 main（e1cfc36b 为 main 祖先，origin 分支已删）；本文分支/推送指引全部作废，只在 main 上工作。阶段2余+阶段3 tick 接线已由 e1cfc36b 完成；剩余待做需重新盘点（阶段1.3/1.4、阶段4、阶段5余）。09-build-progress.md 已删（38dbaab6），git 历史可取。涉教程门的验证项随教程拆除（e8c90e87）作废。
