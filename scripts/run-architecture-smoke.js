...
const CHECK_FILES = Object.freeze([
  ...
  'frontend/js/state/ChangeEventBus.js',
  'frontend/js/state/ChangeEventBus.test.js',
  ...
  'scripts/m0-writer-inventory/check-invariants.js',
  ...
  'backend/application/commands/GameCommandStateSupport.js',
  ...
  'backend/tests/CommandRouteMigration.test.js',
  'backend/tests/OwnerLockRepository.test.js',
  'backend/tests/fixtures/owner-lock-child.js',
  'backend/tests/helpers/commandPipelineTestHarness.js',
  ...
  'backend/tests/M0CommandInvariants.test.js',
...
function main() {
  ...
  run('M0 command invariants blocking guard', process.execPath, [
    'scripts/m0-writer-inventory/check-invariants.js',
  ]);
