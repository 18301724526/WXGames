...
const CHECK_FILES = Object.freeze([
  ...
  'frontend/js/domain/LocaleText.js',
  'frontend/js/domain/LocaleText.test.js',
  ...
  'frontend/js/shared/WorldMarchCoreAdapter.test.js',
  ...
  'frontend/js/platform/CanvasGameShellWorldMapLayerRuntime.test.js',
  ...
  'frontend/js/domain/WorldFogVisionModel.js',
  ...
  'frontend/js/domain/WorldMapPickingModel.test.js',
  'frontend/js/domain/WorldMapInputIntent.js',
  'frontend/js/domain/WorldMapInputIntent.test.js',
  ...
  'frontend/js/domain/WorldActorProjection.js',
  'frontend/js/domain/WorldActorProjection.test.js',
  'frontend/js/domain/WorldMarchProgressSnapshot.js',
  'frontend/js/domain/WorldMarchProgressSnapshot.test.js',
  'frontend/js/domain/WorldMarchOptimisticState.js',
  'frontend/js/domain/WorldMarchOptimisticState.test.js',
  ...
  'frontend/js/platform/CanvasGameAppWorldMapRuntime.js',
  'frontend/js/platform/CanvasGameAppWorldMapRuntime.test.js',
...
function main() {
  ...
  run('frontend ECS bridge shrink report-only guard', process.execPath, [
    'scripts/report-frontend-ecs-bridge-shrink.js',
    '--summary',
  ]);
