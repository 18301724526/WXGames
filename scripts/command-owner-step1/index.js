...
function buildReport(options = {}) {
  ...
  return {
    ...
    nonGoals: [
      'This Step1 report makes no Step2 admission judgment',
      'This Step1 report makes no Step3 migration or enforcement claim',
      'Historical route and handler debt remains report-only until its inventory id is migrated',
    ],
    contractCoverage,
    checks,
    inventories,
