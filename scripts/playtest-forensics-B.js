...
const OUTPUT_DIR = G0 ? path.join(REPO_ROOT, 'tmp', 'forensics-B-g0') : path.join(REPO_ROOT, 'tmp', 'forensics-B');
...
async function main() {
  ...
  try {
    ...
    playtest = spawnLogged(process.execPath, ['scripts/playtest-online-tutorial-hangprobe.js'], {
